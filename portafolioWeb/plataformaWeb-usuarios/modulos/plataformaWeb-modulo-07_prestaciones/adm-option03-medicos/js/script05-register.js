...
btnSave.addEventListener('click', async (e) => {
    ...
    let usuarioElem = document.getElementById('registerUsuario');
    let usuario = usuarioElem ? usuarioElem.textContent.trim() : '';

    // Verifica que el nombre del usuario ya esté cargado y no sea el placeholder
    if (!usuario || usuario === "Cargando usuario...") {
        showMessage(messageWarning, warningText, 'El nombre del usuario aún no se ha cargado. Por favor espere.');
        return;
    }

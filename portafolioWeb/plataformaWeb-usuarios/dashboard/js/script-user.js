...
// Configuración de Firebase para usuarios-d4364
...
console.log("dashboard.js (usuarios) cargado correctamente");
...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        if (!userId || !roles.includes('usuario')) {
            console.log("Acceso denegado: No tienes rol de usuario o userId no encontrado");
            alert("Acceso denegado: No tienes rol de usuario o no estás autenticado.");
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                document.querySelector('.container').style.display = 'block'; // Mostrar el contenedor

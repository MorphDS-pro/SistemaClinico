...
function loadCompaniesRealTime() {
    ...
    onSnapshot(collection(db, 'companies'), (snapshot) => {
        ...
        pageDocs.forEach(company => {
            addRowToTable(company.acciones, company.id, company.empresa || 'Sin Nombre', company.rut, company.registradoPor, company.fechaCreacion, company.id);
        });
...
btnSave.addEventListener('click', async (e) => {
    ...
    try {
        ...
        await addDoc(collection(db, 'companies'), {
            id: idIncremental,
            empresa: companyName, // Cambié nombre por empresa
            rut: rut,
